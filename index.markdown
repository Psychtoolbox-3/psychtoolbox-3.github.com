...
[cited](citations). The current version supports at least Matlab R2025b on Linux, Windows
and macOS, and Octave 6 - 9 on Linux, and Octave 7.3 on Windows, and Octave 10 on macOS.
