...
folder** (ie. without source code), e.g., for Psychtoolbox version 3.0.22.2, it
would be named like `3.0.22.2.zip`. See the following screenshot for the location
...
[For the latest release zip file, click this link.](https://github.com/Psychtoolbox-3/Psychtoolbox-3/releases/latest/download/3.0.22.2.zip)
